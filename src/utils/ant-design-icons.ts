// https://api.iconify.design/ant-design:close-square-outlined.svg

export const antDesignIconNameToUrl = (name: string) => `https://api.iconify.design/ant-design:${name}.svg`;
export const antDesignIconNames = [
  "account-book-filled",
